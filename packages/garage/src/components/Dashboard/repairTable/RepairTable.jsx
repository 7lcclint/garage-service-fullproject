...
function RepairTable() {
    ...
    const reloadReservations = () => {
        ...
        if(token){
            axios.get('https://garage-api-eol1.onrender.com/reservationsByStatusAccept', {
              headers: {
            ...
            axios.get('https://garage-api-eol1.onrender.com/repairData', {
              headers: {
                'Authorization': `Bearer ${token}`
              }
            })
 ...
 */        {
    ...
    useEffect(() => {
        axios
            .get('https://garage-api-eol1.onrender.com/getPromotions')
            .then((response) => {
    ...
    const handleSubmit = () => {
        ...
        if(token){
            axios
                .put(`https://garage-api-eol1.onrender.com/updateRepairData/${selectedRow.repair_id}`, data, {
                    headers: {
                    'Authorization': `Bearer ${token}`
                    }
                })
