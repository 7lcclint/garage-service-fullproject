...
function Calendar() {
    ...
    /* useEffect(() => {
        ...
        axios.get('https://garage-api-eol1.onrender.com/reservations') // Adjust the URL to match your server route
          .then((response) => {
    ...
    const reloadReservations = () => {
        axios
            .get('https://garage-api-eol1.onrender.com/reservations') // Adjust the URL to match your server route
            .then((response) => {
                setReservations(
                    response.data.map((reservation, index) => ({
                        id: index + 1,
    ...
    const handleSubmit = () => {
        if (reservations.length === 0 || !formData.vehicle_reg || !selectedDateTime) {
            ...
            axios
                .post('https://garage-api-eol1.onrender.com/bookqueue', data)
                .then((response) => {
