...
function ReportsRevenue() {
    ...
    useEffect(() => {
        if (startDate && endDate) {
            ...
            fetch(`https://garage-api-eol1.onrender.com/reportRevenueByStartEnd?start_date=${formattedStartDate}&end_date=${formattedEndDate}`)
            ...
            fetch('https://garage-api-eol1.onrender.com/reportRevenueAll')
                .then(response => response.json())
                .then(data => {
                    const reportDataWithIds = data.map((row, index) => ({
                        ...row,
    ...
    const selectY = (e) => {
        ...
        fetch(`https://garage-api-eol1.onrender.com/reportRevenueByMonth/${parseInt(year)}`)
            .then((response) => response.json())
            .then((data) => {
